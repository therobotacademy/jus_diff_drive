...
###### THESE ARE THE PAREMETERS USED IN THE METHODS RELATED TO MAESTRO WORKING IN A DIFFERENTIAL DRIVE CONFIGURATION (code of the methods are appended at the end of the files)
#Motion variables
...
#	print lsb, msb, chr(lsb), chr(msb)
   ...
   ###### THESE ARE THE NEWLY ADDED METHODS FOR MAKE MAESTRO WORK IN DIFFERENTIAL-DRIVE CONFIGURATION
   # Stop both servos
    def stopServos(self):
